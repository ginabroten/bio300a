...
unique_lokaliteter_sum <- combined_data |> 
  summarise(total_unique_lokaliteter = n_distinct(AntallLokaliteter))
...
For å regne ut proportions for fordelingen må vi vite at:
